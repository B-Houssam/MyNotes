...
class Edit extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      isImage: props.route.params.image === '' ? false : true,
      isLocation: false,
      location: '',
      isLoading: false,
      changed: false,
  ...
  render() {
    ...
    const onpressS = () => {
      if (this.state.changed === false) {
        ...
        db.updateNote(this.props.route.params.title, data)
          .then((result) => {
            console.log(result);
            this.setState({
              isLoading: false,
        ...
        <View
          ...
          <View
            ...
            <TextInput
              ...
              onChangeText={(text) =>
                this.setState({body: text, changed: true})
              }
              multiline={true}
              style={{
                fontFamily: 'NunitoSans-Regular',
          ...
          <View
            ...
            <View
              ...
              <RadioForm
                ...
                initial={initial(this.state.cat)}
                ...
                animation={false}
                onPress={(value) => {
                  this.setState({cat: value, changed: true});
                }}
              />
            </View>
